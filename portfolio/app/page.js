...
const projects = [
  {
    title: "NovaCMS",
    tag: "Full-Stack",
    desc: "A blazing-fast headless CMS built with Next.js App Router, Prisma, and a rich drag-and-drop editor. Supports multi-tenant workspaces.",
          ...
          <div className={`contact-grid reveal ${contactInView ? "in delay-1" : ""}`}>
            <div>
              ...
              <div className="social-links">
                ...
                <a href="mailto:hello@danish.dev" className="glass-panel social-btn">
